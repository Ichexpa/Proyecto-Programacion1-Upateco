...
class VentanaPrincipal(tk.Frame):
    ...
    def __init__(self,padre):
        ...
        self.botonEditar=tk.Button(self.tablaDeEventos.contenedorTabla,text="Editar",font=self.fuenteBotones,bg="#43DFAD");
        ...
        self.botonEliminar = tk.Button(
            self.tablaDeEventos.contenedorTabla, text="Eliminar", font=self.fuenteBotones, bg="#DF4843")
