...
class VentanaPrincipal(tk.Frame):
    ...
    def __init__(self,padre):
        ...
        self.tituloLabel = tk.Label(self.frameTitulo, text="Agenda de Eventos", font=(
                                                                                    "consolas", 25, "bold"))
        ...
        self.botonEliminar = tk.Button(
            self.tablaDeEventos.contenedorTabla, text="Eliminar", font=self.fuenteBotones, bg="#DF4843",fg="white")
